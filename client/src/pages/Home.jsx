...
// import NewMovie from "../images/new.jpg";
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import { faSearch, faTheaterMasks, faStar, faThumbsUp, faClock, faFilm, faLanguage, faTv } from '@fortawesome/free-solid-svg-icons';
// import Footer from '../components/Footer';
...
//         <div className="flex items-center bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105">
//           <FontAwesomeIcon icon={faSearch} className="text-white p-2" />
//           <input
//             type="text"
//             placeholder="Search for a movie..."
//             className="p-2 rounded-lg bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-pink-300"
//             value={searchQuery}
...
//               <p className="text-lg font-semibold text-orange-400 flex items-center">
//                 <FontAwesomeIcon icon={faFilm} className="mr-2 text-yellow-400" />
//                 {movie.name}
//               </p>
//               <p className="text-sm text-purple-400 flex items-center">
//                 <FontAwesomeIcon icon={faTv} className="mr-2 text-purple-300" />
//                 Screen: {movie.screen}
//               </p>
//               <p className="text-sm text-green-400 flex items-center">
//                 <FontAwesomeIcon icon={faLanguage} className="mr-2 text-green-300" />
//                 Language: {movie.language}
//               </p>
//               <p className="text-sm text-blue-400 flex items-center">
//                 <FontAwesomeIcon icon={faClock} className="mr-2 text-blue-300" />
//                 Timing: {movie.timing}
//               </p>
//             </div>
