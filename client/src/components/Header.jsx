...
const Header = () => {
  return (
    <header className="bg-gray-800 text-white shadow-lg transition-all duration-300 ease-in-out">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div>
          <a
            href="/sign-in"
            className="bg-yellow-500 text-black px-4 py-2 rounded-lg transform transition-all duration-300 ease-in-out hover:bg-yellow-600 hover:scale-105"
          >
            Login
          </a>
        </div>
