...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-purple-900 text-white py-8 mt-10 shadow-lg backdrop-blur-md animate-pulse">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold mb-2">Cinematic Experience Awaits</h2>
            <p className="text-sm">Book your tickets now for the latest movies!</p>
          </div>
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            >
              <FontAwesomeIcon icon={faFacebookF} className="text-3xl hover:rotate-12 transition duration-300" />
            </a>
            <a 
              href="#" 
              className="hover:text-yellow-400 transition duration-300 transform hover:scale-125"
            >
              <FontAwesomeIcon icon={faTwitter} className="text-3xl hover:rotate-12 transition duration-300" />
            </a>
            <a 
              href="#" 
              className="hover:text-yellow-400 transition duration-300 transform hover:scale-125"
            >
              <FontAwesomeIcon icon={faInstagram} className="text-3xl hover:rotate-12 transition duration-300" />
            </a>
          </div>
        </div>
