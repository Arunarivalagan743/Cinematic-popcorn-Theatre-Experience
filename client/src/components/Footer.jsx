...
// const Footer = () => {
//   return (
//     <footer className="bg-gray-900 text-white py-8 mt-10 transition-transform duration-500 ease-in-out hover:scale-105">
//       <div className="container mx-auto px-4">
//         {/* Top Section */}
//         <div className="flex flex-col md:flex-row justify-between items-center mb-6">
//           <div className="text-center md:text-left">
//             <h2 className="text-2xl font-bold mb-2 transition-opacity duration-500 hover:opacity-80">
