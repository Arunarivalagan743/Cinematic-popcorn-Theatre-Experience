...
//     pass: 'hlkr znlr gexc xhqh',    // Replace with your email password or app password
//   },
// });

// // Function to calculate parking cost
// const calculateParkingCost = (parkingDetails) => {
//   const parkingCostPerVehicle = 5; // Set the cost per vehicle, you can adjust this value
...
//     const totalAmount = bookingData.totalCost + parkingCost; // Add parking cost to the total amount
...
// Parking Details:
// Vehicle Numbers (Two-Wheeler): ${bookingData.parkingDetails && bookingData.parkingDetails.vehicleNumbers && bookingData.parkingDetails.vehicleNumbers.twoWheeler ? bookingData.parkingDetails.vehicleNumbers.twoWheeler.join(', ') : 'N/A'}
// Vehicle Numbers (Four-Wheeler): ${bookingData.parkingDetails && bookingData.parkingDetails.vehicleNumbers && bookingData.parkingDetails.vehicleNumbers.fourWheeler ? bookingData.parkingDetails.vehicleNumbers.fourWheeler.join(', ') : 'N/A'}
